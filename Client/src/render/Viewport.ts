...
import type { Dimension, DrawRect, Vector2 } from '@/types/math'
...
export default class Viewport {
    ...
    getScreenDrawRect(): DrawRect {
        return { dx: 0, dy: 0, ...this.getScreenSize() }
    }
    ...
    getMapDrawRect(): DrawRect {
        ...
        return { dx, dy, width: size, height: size }
    }
