...
import type { CoordinateSpace, Dimension, Rectangle } from '@/types/math'
import CompositorProgram from '@/render/programs/CompositorProgram'
...
export default class CompositorPass {
    ...
    private drawToScreen(texture: Texture, drawRect: Rectangle, screenSize: Dimension) {
        const gl = this.gl

        this.program.use()

        this.quad.setQuad(drawRect.x, drawRect.y, drawRect.width, drawRect.height)
