...
public struct SeString : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static SeString GetRootAsSeString(ByteBuffer _bb) { return GetRootAsSeString(_bb, new SeString()); }
  public static SeString GetRootAsSeString(ByteBuffer _bb, SeString obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SeString __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<WebMap.Networking.Models.SeString> CreateSeString(FlatBufferBuilder builder,
      VectorOffset dataOffset = default(VectorOffset)) {
    builder.StartTable(1);
    SeString.AddData(builder, dataOffset);
    return SeString.EndSeString(builder);
  }

  public static void StartSeString(FlatBufferBuilder builder) { builder.StartTable(1); }
  ...
  public static Offset<WebMap.Networking.Models.SeString> EndSeString(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // data
    return new Offset<WebMap.Networking.Models.SeString>(o);
  }
}


static public class SeStringVerify
{
